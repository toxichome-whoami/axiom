...
pub fn get_router() -> Router {
    Router::new()
        ...
        .route(
            "/totp/backup/regenerate",
            get(handler_totp_backup_regenerate),
        )
        // Session management
        ...
        .route(
            "/admin/templates/:type_name",
            axum::routing::put(admin_update_template).delete(admin_delete_template),
        )
        ...
        .route(
            "/user",
            get(handler_get_me)
                .patch(handler_update_me)
                .delete(handler_delete_me),
        )
